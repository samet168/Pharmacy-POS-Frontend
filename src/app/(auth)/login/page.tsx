            ...
            <div className="space-y-3 mb-6">
              ...
              {(!gsiLoaded || googleLoading) && (
                <button
                  ...
                  onClick={() => {
                    const email = prompt('បញ្ចូល Google Email របស់អ្នក:', 'pharmacist@pharmacy.pos');
                    if (email) {
                  ...
                  className="w-full py-2.5 px-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 rounded-full font-bold text-xs shadow-xs flex items-center justify-center gap-3 transition-all"
                >
